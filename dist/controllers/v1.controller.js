...
let V1Controller = class V1Controller {
    constructor(secretKey, host, origin, userAgent, contentType, httpMethod, relayPath, relayRetries, dispatchURL, pocketSessionBlockFrequency, pocketBlockTime, clientPrivateKey, clientPassphrase, pocketJSInstances, redis, pgPool, databaseEncryptionKey, processUID, fallbackURL, requestID, applicationsRepository, blockchainsRepository, loadBalancersRepository) {
...
V1Controller = tslib_1.__decorate([
    ...
    tslib_1.__param(8, context_1.inject('dispatchURL')),
    tslib_1.__param(9, context_1.inject('pocketSessionBlockFrequency')),
    tslib_1.__param(10, context_1.inject('pocketBlockTime')),
    tslib_1.__param(11, context_1.inject('clientPrivateKey')),
    tslib_1.__param(12, context_1.inject('clientPassphrase')),
    tslib_1.__param(13, context_1.inject('pocketJSInstances')),
    tslib_1.__param(14, context_1.inject('redisInstance')),
    tslib_1.__param(15, context_1.inject('pgPool')),
    tslib_1.__param(16, context_1.inject('databaseEncryptionKey')),
    tslib_1.__param(17, context_1.inject('processUID')),
    tslib_1.__param(18, context_1.inject('fallbackURL')),
    tslib_1.__param(19, context_1.inject('requestID')),
    tslib_1.__param(20, repository_1.repository(repositories_1.ApplicationsRepository)),
    tslib_1.__param(21, repository_1.repository(repositories_1.BlockchainsRepository)),
    tslib_1.__param(22, repository_1.repository(repositories_1.LoadBalancersRepository)),
    tslib_1.__metadata("design:paramtypes", [String, String, String, String, String, String, String, Number, String, Number, Number, String, String, Object, Object, pg_1.Pool, String, String, String, String, repositories_1.ApplicationsRepository,
